var ProofSpace = (function (e) {
  ...
  var T,
    ...
    S = Object.freeze({
      ...
      __createBinding: function (e, t, n, i) {
      ...
      __asyncGenerator: function (e, t, n) {
          ...
          r[e] &&
            (i[e] = function (t) {
              return new Promise(function (n, i) {
                o.push([e, t, n, i]) > 1 || T(e, t);
              });
            });
        }
        function T(e, t) {
          try {
            (n = r[e](t)).value instanceof s
        ...
        function S(e, t) {
          e(t), o.shift(), o.length && T(o[0][0], o[0][1]);
        }
      },
      ...
      e.exports = (function () {
        ...
        function i(e, i, r) {
          for (
            ...
            for (o in (a = r[s])) (e && !t.call(a, o)) || (i[o] = a[o]);
        }
        var r = function (t, n, r, o) {
          var a = this;
          return (
            "string" != typeof t && ((o = r), (r = n), (n = t), (t = null)),
            "function" != typeof n &&
              ((o = r),
              (r = n),
              (n = function () {
            ...
            (n.prototype = (function (t, n) {
              ...
              return (
                "function" == typeof Object.create
                  ? (r = Object.create(t))
                  : ((e.prototype = t), (r = new e()), (e.prototype = null)),
                n && i(!0, r, n),
                r
              );
            })(a.prototype, r)),
        ...
        var a = o,
          ...
          b = a.extend(
            function (e) {
              ...
              (this.buffer = b._createArray(s * s)),
                (this._ecc = b._createArray(t + (t + n) * (r + o) + o)),
                (this._mask = b._createArray((s * (s + 1) + 1) / 2)),
                this._insertFinders(),
            ...
            },
            {
              ...
              _appendData: function (e, t, n, i) {
                ...
                for (o = 0; o < t; o++) {
                  if (255 !== (r = S.LOG[T[e + o] ^ T[n]]))
                    for (a = 1; a < i; a++)
                      T[n + a - 1] =
                        T[n + a] ^ S.EXPONENT[b._modN(r + s[i - a])];
                  else for (a = n; a < n + i; a++) T[a] = T[a + 1];
                  T[n + i - 1] = 255 === r ? 0 : S.EXPONENT[b._modN(r + s[0])];
                }
              },
              _appendEccToData: function () {
                ...
                for (e = 0; e < this._neccBlock1; e++)
                  this._appendData(t, n, i, r), (t += n), (i += r);
                for (e = 0; e < this._neccBlock2; e++)
                  this._appendData(t, n + 1, i, r), (t += n + 1), (i += r);
              },
              _applyMask: function (e) {
                ...
                switch (e) {
                  ...
                  case 1:
                    for (r = 0; r < a; r++)
                      for (i = 0; i < a; i++)
                        1 & r || this._isMasked(i, r) || (o[i + r * a] ^= 1);
                    break;
                  case 2:
                    for (r = 0; r < a; r++)
                      for (t = 0, i = 0; i < a; i++, t++)
                        3 === t && (t = 0),
                          t || this._isMasked(i, r) || (o[i + r * a] ^= 1);
                    break;
                  case 3:
                    for (n = 0, r = 0; r < a; r++, n++)
                      for (3 === n && (n = 0), t = n, i = 0; i < a; i++, t++)
                        3 === t && (t = 0),
                          t || this._isMasked(i, r) || (o[i + r * a] ^= 1);
                    break;
                  case 4:
                    for (r = 0; r < a; r++)
                      for (t = 0, n = (r >> 1) & 1, i = 0; i < a; i++, t++)
                        3 === t && ((t = 0), (n = !n)),
                          n || this._isMasked(i, r) || (o[i + r * a] ^= 1);
                    break;
                  case 5:
                    for (n = 0, r = 0; r < a; r++, n++)
                      for (3 === n && (n = 0), t = 0, i = 0; i < a; i++, t++)
                        3 === t && (t = 0),
                          (i & r & 1) + !(!t | !n) ||
                            this._isMasked(i, r) ||
                            (o[i + r * a] ^= 1);
              ...
              _calculatePolynomial: function () {
                ...
                for (i[0] = 1, e = 0; e < n; e++) {
                  for (i[e + 1] = 1, t = e; t > 0; t--)
                    i[t] = i[t]
                      ? i[t - 1] ^ S.EXPONENT[b._modN(S.LOG[i[t]] + e)]
                      : i[t - 1];
              ...
              _checkBadness: function () {
                ...
                var l = 0;
                for (r = 0; r < T; r++) {
                  for (n = 0, a[0] = 0, e = 0, i = 0; i < T; i++)
                    e === (t = s[i + T * r]) ? a[n]++ : (a[++n] = 1),
                      (l += (e = t) ? 1 : -1);
                ...
                var c = 0,
                  S = l;
                for (S += S << 2, S <<= 1; S > T * T; ) (S -= T * T), c++;
                for (o += c * b.N4, i = 0; i < T; i++) {
                  for (n = 0, a[0] = 0, e = 0, r = 0; r < T; r++)
                    e === (t = s[i + T * r]) ? a[n]++ : (a[++n] = 1), (e = t);
                  o += this._getBadness(n);
                }
                return o;
              },
              _convertBitStream: function (e) {
                var t,
                  ...
                  i = this._ecc,
                  r = this._version;
                for (n = 0; n < e; n++) i[n] = this._value.charCodeAt(n);
              ...
              _getBadness: function (e) {
                var t,
                  n = 0,
                  i = this._badness;
                for (t = 0; t <= e; t++) i[t] >= 5 && (n += b.N1 + i[t] - 5);
                for (t = 3; t < e - 1; t += 2)
                  i[t - 2] === i[t + 2] &&
                    i[t + 2] === i[t - 1] &&
                    i[t - 1] === i[t + 1] &&
              ...
              _finish: function () {
                ...
                for (
                  ...
                  t < 8 &&
                  (this._applyMask(t),
                  (e = this._checkBadness()) < i && ((i = e), (n = t)),
                  7 !== n);
                  t++
                )
                  this.buffer = this._stringBuffer.slice();
                n !== t && this._applyMask(n),
                  (i = c.FINAL_FORMAT[n + ((this._level - 1) << 3)]);
                var r = this.buffer,
                  o = this.width;
                for (t = 0; t < 8; t++, i >>= 1)
                  1 & i &&
                    ((r[o - 1 - t + 8 * o] = 1),
                    t < 6 ? (r[8 + o * t] = 1) : (r[8 + o * (t + 1)] = 1));
                for (t = 0; t < 7; t++, i >>= 1)
                  1 & i &&
                    ((r[8 + o * (o - 7 + t)] = 1),
                    t ? (r[6 - t + 8 * o] = 1) : (r[7 + 8 * o] = 1));
              },
              _interleaveBlocks: function () {
                ...
                for (e = 0; e < n; e++) {
                  for (t = 0; t < s; t++) i[o++] = l[e + t * n];
                  for (t = 0; t < T; t++) i[o++] = l[s * n + e + t * (n + 1)];
                }
                for (t = 0; t < T; t++) i[o++] = l[s * n + e + t * (n + 1)];
                for (e = 0; e < r; e++)
                  for (t = 0; t < s + T; t++) i[o++] = l[a + e + t * r];
              ...
              _insertAlignments: function () {
                ...
                if (i > 1)
                  for (e = l.BLOCK[i], n = r - 7; ; ) {
                    for (
                      t = r - 7;
                      t > e - 3 && (this._addAlignment(t, n), !(t < e));
              ...
              _insertTimingRowAndColumn: function () {
                ...
                for (e = 0; e < n - 14; e++)
                  1 & e
                    ? (this._setMask(8 + e, 6), this._setMask(6, 8 + e))
                    : ((t[8 + e + 6 * n] = 1), (t[6 + n * (8 + e)] = 1));
              },
              _insertVersion: function () {
                var e,
                  ...
                  a = this.width;
                if (o > 6)
                  for (e = u.BLOCK[o - 7], t = 17, n = 0; n < 6; n++)
                    for (i = 0; i < 3; i++, t--)
                      1 & (t > 11 ? o >> (t - 12) : e >> t)
                        ? ((r[5 - n + a * (2 - i + a - 11)] = 1),
                          (r[2 - i + a - 11 + a * (5 - n)] = 1))
                        : (this._setMask(5 - n, 2 - i + a - 11),
                          this._setMask(2 - i + a - 11, 5 - n));
              },
              ...
              _reverseMask: function () {
                ...
                for (e = 0; e < 8; e++)
                  this._setMask(e + n - 8, 8), this._setMask(8, e);
          ...
          A = a.extend(
            ...
            },
            {
              ...
              get: function (e, t) {
                return A._get(this.options[e], t);
              },
              getAll: function (e) {
                var t,
                  n = this.options,
                  i = {};
                for (t in n) P.hasOwn(n, t) && (i[t] = A._get(n[t], e));
                return i;
              },
              init: function (e, t, n) {
                var i, r;
                for (i in ("function" != typeof n && (n = P.noop),
                this.options))
                  P.hasOwn(this.options, i) &&
                    ((r = this.options[i]),
                    A._set(r, r.defaultValue, t),
                    A._createAccessor(r, t, n));
                this._setAll(e, t, !0);
              },
              set: function (e, t, n) {
              ...
              _setAll: function (e, t, n) {
                ...
                var i,
                  r = !1;
                for (i in e)
                  P.hasOwn(e, i) && this._set(i, e[i], t, n) && (r = !0);
                return r;
              },
            },
            {
          ...
          G = a.extend(
            ...
            },
            {
              getService: function (e) {
                ...
                if (!t)
                  throw new Error(
                    "Service is not being managed with name: " + e
                  );
                return t;
              },
          ...
          B = new f([
            ...
            new d("backgroundAlpha", !0, 1, P.abs),
            new d("element"),
            new d("foreground", !0, "black"),
            new d("foregroundAlpha", !0, 1, P.abs),
            new d("level", !0, "L", P.toUpperCase),
            new d("mime", !0, "image/png"),
            new d("padding", !0, null, P.abs),
            new d("size", !0, 100, P.abs),
            new d("value", !0, ""),
          ]),
          p = new G(),
          C = a.extend(
            function (e) {
              ...
              (this._canvasRenderer = new T(this, i, !0)),
                (this._imageRenderer = new M(this, r, r === t)),
                this.update();
            },
            {
              get: function () {
              ...
              update: function () {
                var e = new h({ level: this.level, value: this.value });
        ...
        return (
          ...
          (function () {
            ...
            for (i in c.props)
              if (n.call(c.props, i)) {
                for (
                  r = c.props[i], e(r) || (r = [r]), T = r.length, s = 0;
                  s < T;
                  ++s
                )
                  (l = (a = r[s]).indexOf("[VER]")) >= 0 &&
                    (a =
                      a.substring(0, l) + "([\\w._\\+]+)" + a.substring(l + 5)),
                    (r[s] = new RegExp(a, "i"));
                c.props[i] = r;
              }
            o(c.oss),
    ...
    m = function (e) {
      for (var t, n, i, r, o = "", a = e.length % 3, s = 0; s < e.length; ) {
        if (
    ...
    I = d
      ...
      : function (e) {
          for (var t = [], n = 0, i = e.length; n < i; n += 4096)
            t.push(p.apply(null, e.subarray(n, n + 4096)));
          return v(t.join(""));
        },
    _ = function (e) {
    ...
    j = function () {
      var e = function (e, t) {
        return Object.defineProperty(String.prototype, e, z(t));
      };
    ...
    Y = function () {
      var e = function (e, t) {
        return Object.defineProperty(Uint8Array.prototype, e, z(t));
      };
      e("toBase64", function (e) {
        return _(this, e);
      }),
    ...
    $ = t(function (e, t) {
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.WebLinker =
          ...
          t.sum =
            void 0);
      var n,
        i = S.__importDefault(u),
        r = S.__importDefault(b);
      function o(e, t, i) {
        return S.__awaiter(this, void 0, void 0, function () {
          ...
          return S.__generator(this, function (l) {
            switch (l.label) {
              ...
              case 1:
                return (o = l.sent()).ok ? [3, 3] : [4, o.text()];
              case 2:
              ...
              case 6:
                return (
                  (T = l.sent()), console.log("Can't parse json:", T), [3, 7]
                );
              case 7:
                return [2, s];
            }
      ...
      var a = (function () {
          ...
          return (
                ...
                return S.__generator(this, function (r) {
                  switch (r.label) {
                    case 0:
                      return (
                        this.assertCfg(),
                        (i = ["client_id=" + encodeURI(e)]),
                        t && i.push("scope=" + t),
                        [
                          4,
                          o(
                            this.cfg.requestAuthorizationUri,
                            n.POST,
                            i.join("&")
                          ),
                        ]
            ...
            (e.prototype.assertCfg = function () {
              if (!this.cfg) throw new Error("Api is not initialized");
            }),
            e
          );
        })(),
        s = (function () {
          ...
          return (
            (e.prototype.isExpired = function () {
              return new Date().getTime() - this.startTs >= this.expiresIn;
            }),
            (e.prototype.leftTimeStr = function () {
              var e = Math.ceil(
                  (this.expiresIn - (new Date().getTime() - this.startTs)) / 1e3
                ),
                t = Math.floor(e / 60);
              e %= 60;
          ...
          return (
                      ...
                      return (
                        ...
                        this.api.init({
                          requestAuthorizationUri:
                            this.authServiceUrl + "/device_authorization",
                          requestTokenUri: this.authServiceUrl + "/token",
                        }),
                        [
                          4,
                          this.api.requestAuthorization(this.clientId, e.scope),
                        ]
                      );
                    case 1:
                      return (
                        (t = r.sent()),
                        this.userCodeHandler(t.user_code),
                        (this.timeWatcher = new s(1e3 * t.expires_in)),
                        (this.timer = setInterval(function () {
                          return i.updateTimer();
                        }, 1e3)),
                        t.interval && (this.pollingInterval = t.interval),
                        [4, this.getToken(t)]
                      );
                    case 2:
                      return (
                        (n = r.sent()),
                        e.log("Token received! " + n.access_token),
                        [2, n]
                      );
                  }
                });
                    ...
                    case 0:
                      (n = !1),
                        (i = e.initial_interval
                          ? 1e3 * e.initial_interval
                          : 1e4),
                        (o.label = 1);
                    case 1:
                      return (
                        o.trys.push([1, 3, , 4]),
                        [4, this.tryToGetToken(e.device_code, i)]
                      );
                    case 2:
                      return (t = o.sent()), [3, 4];
                    case 3:
                      if ("expired_token" === (r = o.sent()).error)
                        throw ((n = !0), this.stopTimer(), r);
                      if ("slow_down" === r.error) this.pollingInterval += 5;
                      else if ("authorization_pending" !== r.error)
                        throw (this.stopTimer(), r);
                      return [3, 4];
                    case 4:
                      (i = 1e3 * this.pollingInterval), (o.label = 5);
                    case 5:
                      if (!t || n) return [3, 1];
                      o.label = 6;
                    case 6:
              ...
              return S.__awaiter(this, void 0, void 0, function () {
                return S.__generator(this, function (i) {
                  switch (i.label) {
                    ...
                    case 1:
                      return (
                        i.sent(), [4, this.api.requestToken(e, this.clientId)]
                      );
                    case 2:
                      return [2, i.sent()];
                  }
            ...
            (e.prototype.updateTimer = function () {
              this.timerHandler(this.timeWatcher.leftTimeStr()),
                this.timeWatcher.isExpired() && this.stopTimer();
            }),
            e
          );
        })(),
                ...
                return S.__generator(this, function (e) {
                  switch (e.label) {
                    case 0:
                      return (
                        this.assertCfg(),
                        [4, o(this.cfg.requestInstancesUri, n.GET)]
                      );
                    case 1:
                      return [2, e.sent()];
                  }
        ...
        h = "https://test.proofspace.id/",
        M = "https://test.proofspace.id/",
        d = {
          containerURIPrefix: c + "service-dashboard-backend/",
          SSIAuthenticationCredDefId: "GbzPqgnU4XsMs7xg9mYJW8:3:CL:77:tag",
          authServiceUrl: c + "oauth/",
          nativeURIPrefix: c + "native/execute/",
        },
        P = {
          containerURIPrefix: h + "service-dashboard-backend/",
          SSIAuthenticationCredDefId: "Wv5tREzxvixFw9MpUxcu1J:3:CL:509:tag",
          authServiceUrl: h + "oauth/",
          nativeURIPrefix: h + "native/execute/",
        },
        A = {
          containerURIPrefix: M + "service-dashboard-backend/",
          SSIAuthenticationCredDefId: "Wv5tREzxvixFw9MpUxcu1J:3:CL:509:tag",
          authServiceUrl: M + "oauth/",
          nativeURIPrefix: M + "native/execute/",
        };
      function f(e) {
        return "/" !== e[e.length - 1] ? e + "/" : e;
      }
      t.ENV = { PROD: d, STAGE: A, TEST: P };
      var G = function (e, t) {
          t && t.class
        ...
        p = (function () {
          ...
          return (
            ...
            (e.prototype.register = function (e) {
              this.watchers.indexOf(e) < 0 && this.watchers.push(e);
            }),
        ...
        C = (function () {
            ...
            (this.btn = e),
              ...
              (this.onBtnClick = function (e) {
                i.opened ||
                  (e.stopPropagation(),
                  (i.opened = !0),
                  G(i.popOver, i.openedStyle),
                  document.addEventListener("click", i.onDocumentClick),
                  p.instance().handleOpen(i),
                  void 0 !== i.handler && i.handler());
              }),
              (this.onDocumentClick = function (e) {
                i.opened
                  ? i.popOver.contains(e.target) || i.close()
                  : document.removeEventListener("click", i.onDocumentClick);
              }),
              G(this.popOver, { style: B }),
          ...
          return (
            ...
            (e.prototype.close = function () {
              document.removeEventListener("click", this.onDocumentClick),
                this.opened &&
                  ((this.opened = !1), G(this.popOver, { style: B }));
            }),
            e
          );
        })();
      (t.isMobile = function () {
        ...
        (t.isAndroid = function () {
          return "AndroidOS" === new r.default(window.navigator.userAgent).os();
        });
      var H = (function () {
        function e() {
          (this.api = new l()),
        ...
        return (
              ...
              return S.__generator(this, function (o) {
                return (
                    ...
                    return S.__awaiter(r, void 0, void 0, function () {
                      ...
                      return S.__generator(this, function (r) {
                        switch (r.label) {
                          case 0:
                            return (
                              this.log("SSI OAuth user code received " + e),
                              (t = n || []).push({
                                credentialId:
                                  this.env.SSIAuthenticationCredDefId,
                                attributes: [
                                  { name: "OAuth User Code", value: e },
                                ],
                              }),
                              [
                                4,
                  ...
                  [
                    2,
                    this.ssiOauth.start({
                      clientId: i.serviceDid,
                      authServiceUrl: this.env.authServiceUrl,
                      log: this.log,
                    }),
                  ]
                );
                ...
                switch (s.label) {
                  case 0:
                    return (
                      ...
                      l && l.style && (c.style = "" + c.style + l.style),
                      ...
                      n.popOverMode
                        ...
                        : [
                            ...
                            this.initElement(
                              n,
                              i || [],
                              n.returnToBrowser ? window.location.href : void 0
                            ),
                          ]
                    );
                  case 1:
                    ...
                    t.isMobile()
                      ? ((o = function () {
                          return window.open(
                            ...
                            n.button && n.button.target
                              ? n.button.target
                              : "_self"
                          );
                        }),
                        e.addEventListener("click", o))
                      : ((this.popOverWatcher = new C(e, this.qrElement, r)),
                        this.popOverWatcher.onOpen(function () {
          ...
          (e.prototype.prepareElements = function (e, t) {
            t.popOverMode || (e.innerHTML = ""),
              ...
              this.api.init({
                requestInstancesUri:
                  "" +
                  f(this.env.containerURIPrefix) +
                  t.serviceDid +
                  "/info/action-instances/" +
                  t.interactionId,
              }),
              (this.qrElement = document.createElement("div")),
              t.popOverMode || this.qrElement.setAttribute("style", B),
              (this.canvasElement = document.createElement("canvas")),
              this.qrElement.appendChild(this.canvasElement),
              (this.buttonElement = document.createElement("button")),
              this.buttonElement.setAttribute("style", B),
              (this.timerElement = document.createElement("div")),
              G(this.timerElement, t.timer),
          ...
          (e.prototype.setConfig = function (e) {
            e.size && (this.size = e.size), e.env && (this.env = e.env);
          }),
              ...
              return S.__generator(this, function (a) {
                switch (a.label) {
                  case 0:
                    return t.isMobile()
                      ? ((r = function () {
                          o.buttonElement.setAttribute("disabled", "disabled"),
                            o.buttonElement.removeEventListener("click", r),
                            o.switchButtonToLoadingState(e),
                            window.open(
                              o.getURI(e, n || [], i),
                              e.button && e.button.target
                                ? e.button.target
                                : "_self"
                            );
                        }),
                        this.initButton(e),
                        this.buttonElement.addEventListener("click", r),
                        [3, 3])
                      : [3, 1];
                  case 1:
                    return (
                      e.popOverMode || G(this.qrElement, e.qr),
                      [4, this.drawQrCode(this.getURI(e, n))]
                    );
                  case 2:
                    a.sent(), (a.label = 3);
                  case 3:
          ...
          (e.prototype.switchButtonToLoadingState = function (e) {
            var t = e.loadingButton,
              n = e.loadingText;
            (this.buttonElement.innerHTML = ""), t && G(this.buttonElement, t);
            var i = document.createElement("span");
            G(i, n),
              (i.innerHTML =
                n && n.text ? n.text : "Waiting for interaction..."),
              this.buttonElement.appendChild(i);
          }),
          (e.prototype.initButton = function (e) {
            var t = e.button;
            if ((G(this.buttonElement, t), t && t.icon)) {
            ...
            t && G(r, t.textStyle),
              (r.innerHTML = t && t.text ? t.text : "Start interaction"),
          ...
          (e.prototype.getURI = function (e, n, i) {
            ...
            var o = J.Base64.encode(JSON.stringify(r), !e.useBase64Unsafe);
            return "" + f(this.env.nativeURIPrefix) + o;
          }),
          (e.prototype.prepareCallBack = function (e) {
            return (
              ...
              navigator.userAgent.indexOf("CriOS") >= 0
                ? (this.log("Chrome detected"), "googlechrome://")
                : "/" === e.slice(-1)
              ...
              return S.__generator(this, function (r) {
                switch (r.label) {
                  ...
                  case 1:
                    return (
                      r.sent(),
                      (n = { element: this.canvasElement, value: e }),
      ...
      (t.PSWebLink = H), (t.WebLinker = new H());
    }),
    ee =
      (c = $) &&
      c.__esModule &&
